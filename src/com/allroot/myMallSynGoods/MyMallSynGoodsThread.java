...
public class MyMallSynGoodsThread implements Runnable{
	...
	public static void synJoomGoods() {
		...
		MyMallSynGoodsThread getThread = new MyMallSynGoodsThread();
	...
	public void run() {
		...
		MyMallSynGoods pro = new MyMallSynGoods();
		while (true) {
			user = getSynUser();			
			if (user == null) {
